...
v0, d0 = ps.flat_start()
v_nr, d_nr, it_nr = ps.pf_newtonraphson(v0, d0, prec=2, maxit=10, qlim=False)
# v_nr, d_nr, it_nr = ps.pf_newtonraphson(v_nr, d_nr, prec=2, maxit=10, qlim=True)
v_fd, d_fd, it_fd = ps.pf_fast_decoupled(v0, d0, prec=2, maxit=1000, qlim=False)
# v_fd, d_fd, it_fd = ps.pf_fast_decoupled(v_fd, d_fd, prec=2, maxit=1000, qlim=True)
