from classes.dynamics_cuda import *
...
if __name__ == "__main__":
	...
	# Fault On
	fault_case = 'CaseFiles/Kundur_modified_fault.txt'
	...
	def f(x_input):
		return dpsf.dyn2_f(x_input, type2['vref'], type2['Pc'], limits=False)
	...
	# Fault Cleared
	clear_case = 'CaseFiles/Kundur_modified_cleared.txt'
	...
	def f(x_input):
		return dpsc.dyn2_f(x_input, type2['vref'], type2['Pc'], limits=False)
	t_end = 20
	while t < t_end:
		t = t + h
		xk = xk + h * f(xk)
	...
	fig2.show()
	# fig2.savefig("theta_type2_3cycle.png")
	fig3 = plt.figure()
