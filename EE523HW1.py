...
for case_name, results_file in cases:
	...
	v_nr, d_nr, it_nr = ps.pf_newtonraphson(v0, d0, prec=3, maxit=8, qlim=False, debug_file="NRdebug"+results_file)
	...
	nrd = {
		...
		"Type": ps.bus_data[:, 4],
		"V Result": v_nr,
		"Angle Result": d_nr*180/np.pi+20.2,
	...
	fdd = {
		...
		"Type": ps.bus_data[:, 4],
		"V Result": v_fd,
		"Angle Result": d_fd*180/np.pi+20.2,
